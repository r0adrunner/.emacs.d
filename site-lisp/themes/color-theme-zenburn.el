  ...
  (color-theme-install
   (append
    (list 'color-theme-zenburn
     ...
     `(org-level-1 ((t (:bold t :height 1.5 :foreground ,zenburn-orange))))
     `(org-level-2 ((t (:bold nil :height 1.2 :foreground ,zenburn-yellow))))
     `(org-level-3 ((t (:bold t :height 1.0 :foreground ,zenburn-blue))))
