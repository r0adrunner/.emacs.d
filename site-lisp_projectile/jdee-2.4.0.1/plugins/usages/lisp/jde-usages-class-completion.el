...
(jde-jeval (concat "out = new java.io.PrintStream (new java.io.BufferedOutputStream (new java.io.FileOutputStream (new java.io.File (\"" classes-file "\")))); jde.util.Usages.getAllClasses (out); out.close();"))
